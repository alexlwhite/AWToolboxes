...
% - opt: the original input options structure, possibly with additions 
% - allX: the cell array of x-positions of individual points 
...
%     end
    ...
    fprintf(1,'\n\n(%s) WARNING: connectLev1IndivPts is not coded to ensure connected points have same-xjitter so slopes are comparable\n', mfilename);
end
