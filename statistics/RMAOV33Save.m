function [RMAOV33] = RMAOV33Save2(X,alpha,sfile)
...
disp('   ');
fprintf(sfile,'The number of IV1 levels are:%2i\n', a);
fprintf(sfile,'The number of IV2 levels are:%2i\n', b);
fprintf(sfile,'The number of IV3 levels are:%2i\n', c);
fprintf(sfile,'The number of subjects are:   %2i\n\n', s);
...
fprintf(sfile,'Three-Way Analysis of Variance With Repeated Measures on Three Factors (Within-Subjects) Table.')
fprintf(sfile,'\n---------------------------------------------------------------------------------------------------\n');
fprintf(sfile,'SOV \tSS \tdf \tMS \tF \tP \tConclusion');
fprintf(sfile,'\n---------------------------------------------------------------------------------------------------\n');
fprintf(sfile,'Between-Subjects\t %11.3f\t%10i\n\n',SSS,v15);
fprintf(sfile,'Within-Subjects\t %11.3f\t%10i\n',SSWS,vWS);
fprintf(sfile,'IV1 \t%11.3f\t%10i\t%15.3f\t%14.3f\t%9.4f\t%9s\n',SSA,v1,MSA,F1,P1,ds1);
fprintf(sfile,'Error(IV1)               \t%11.3f\t%10i\t%15.3f\n\n',SSEA,v2,MSEA);
fprintf(sfile,'IV2                      \t%11.3f\t%10i\t%15.3f\t%14.3f\t%9.4f\t%9s\n',SSB,v3,MSB,F2,P2,ds2);
fprintf(sfile,'Error(IV2)               \t%11.3f\t%10i\t%15.3f\n\n',SSEB,v4,MSEB);
fprintf(sfile,'IV3                      \t%11.3f\t%10i\t%15.3f\t%14.3f\t%9.4f\t%9s\n',SSC,v5,MSC,F3,P3,ds3);
fprintf(sfile,'Error(IV3)               \t%11.3f\t%10i\t%15.3f\n\n',SSEC,v6,MSEC);
fprintf(sfile,'IV1xIV2                  \t%11.3f\t%10i\t%15.3f\t%14.3f\t%9.4f\t%9s\n',SSAB,v7,MSAB,F4,P4,ds4);
fprintf(sfile,'Error(IV1xIV2)           \t%11.3f\t%10i\t%15.3f\n\n',SSEAB,v8,MSEAB);
fprintf(sfile,'IV1xIV3                  \t%11.3f\t%10i\t%15.3f\t%14.3f\t%9.4f\t%9s\n',SSAC,v9,MSAC,F5,P5,ds5);
fprintf(sfile,'Error(IV1xIV3)           \t%11.3f\t%10i\t%15.3f\n\n',SSEAC,v10,MSEAC);
fprintf(sfile,'IV2xIV3                  \t%11.3f\t%10i\t%15.3f\t%14.3f\t%9.4f\t%9s\n',SSBC,v11,MSBC,F6,P6,ds6);
fprintf(sfile,'Error(IV2-IV3)           \t%11.3f\t%10i\t%15.3f\n\n',SSEBC,v12,MSEBC);
fprintf(sfile,'IV1xIV2xIV3              \t%11.3f\t%10i\t%15.3f\t%14.3f\t%9.4f\t%9s\n',SSABC,v13,MSABC,F7,P7,ds7);
fprintf(sfile,'Error(IV1-IV2-IV3)       \t%11.3f\t%10i\t%15.3f\n',SSEABC,v14,MSEABC);
fprintf(sfile,'---------------------------------------------------------------------------------------------------\n');
fprintf(sfile,'Total                    \t%11.3f\t%10i\n',SSTO,v16);
fprintf(sfile,'---------------------------------------------------------------------------------------------------\n');
fprintf(sfile,'With a given significance level of: %.2f\n', alpha);
fprintf(sfile,'The results are significant (S) or not significant (NS).');
